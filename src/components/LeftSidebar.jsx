...
export default function LeftSidebar({
  ...
  return (
    <aside className="w-80 lg:w-96 flex-shrink-0 bg-white border-r border-slate-300 flex flex-col h-full sticky top-0 shadow-xs z-20 select-none font-sans">
      ...
      <div className="p-4 border-b border-slate-300 bg-gradient-to-br from-emerald-950 via-teal-900 to-slate-900 text-white relative overflow-hidden">
        ...
        <div className="flex items-center gap-3 relative z-10">
          ...
          <div>
            <h1 className="text-xs sm:text-sm font-black tracking-wide uppercase text-white leading-tight">
              HẠT KIỂM LÂM KHU VỰC KRÔNG BÔNG
            </h1>
            <p className="text-xs text-emerald-200/90 font-bold flex items-center gap-1 mt-0.5">
          ...
          <nav className="space-y-2">
            ...
            {currentUser?.role === 'FACILITY' ? (
              <button
                ...
                className="w-full flex items-center justify-between px-4 py-3 rounded-2xl text-sm font-extrabold bg-gradient-to-r from-emerald-600 to-teal-700 text-white shadow-md shadow-emerald-600/20 translate-x-1 cursor-pointer"
              >
              ...
              <>
                ...
                <button
                  ...
                  className={`w-full flex items-center justify-between px-4 py-3 rounded-2xl text-sm font-extrabold transition-all cursor-pointer ${
                    isNavActive('HOME')
                      ? 'bg-gradient-to-r from-emerald-600 to-teal-700 text-white shadow-md shadow-emerald-600/20 translate-x-1'
                      : 'text-slate-800 hover:bg-emerald-50/80 hover:text-emerald-950 border border-transparent hover:border-emerald-200/60'
                  }`}
                >
                  <div className="flex items-center gap-3">
                    <BarChart3 className={`w-5 h-5 ${isNavActive('HOME') ? 'text-white' : 'text-emerald-600'}`} />
                ...
                >
                  <div className="flex items-center gap-3">
                    <LayoutList className={`w-5 h-5 ${isNavActive('SUMMARY') ? 'text-white' : 'text-emerald-600'}`} />
                ...
                >
                  <div className="flex items-center gap-3">
                    <Table className={`w-5 h-5 ${isNavActive('LOGBOOK') ? 'text-white' : 'text-emerald-600'}`} />
                ...
                >
                  <div className="flex items-center gap-3">
                    <MapPin className={`w-5 h-5 ${isNavActive('MAP') ? 'text-white' : 'text-emerald-600'}`} />
        ...
        <div>
          ...
          <div className="space-y-2">
            ...
            <button
              ...
              className="w-full flex items-center justify-between px-4 py-3 rounded-2xl text-sm font-extrabold text-white bg-gradient-to-r from-emerald-600 to-teal-700 hover:from-emerald-700 hover:to-teal-800 shadow-md shadow-emerald-600/20 transition-all hover:scale-[1.01] active:scale-[0.99] cursor-pointer"
            >
              <div className="flex items-center gap-3">
            ...
            {currentUser?.role !== 'FACILITY' && (
              <button
                ...
                className="w-full flex items-center justify-between px-4 py-3 rounded-2xl text-sm font-extrabold text-emerald-950 bg-emerald-50/90 hover:bg-emerald-100 border border-emerald-200/90 hover:border-emerald-300 transition-all hover:scale-[1.01] active:scale-[0.99] cursor-pointer shadow-2xs"
              >
                <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="w-full flex items-center justify-between px-4 py-3 rounded-2xl text-sm font-extrabold text-slate-800 hover:text-emerald-950 bg-slate-50/90 hover:bg-emerald-50/90 border border-slate-200/90 hover:border-emerald-200/90 transition-all cursor-pointer"
            >
              <div className="flex items-center gap-3">
        ...
        {currentUser?.role === 'ADMIN' && (
          <div>
            ...
            <div className="space-y-2">
              ...
              >
                <div className="flex items-center gap-3">
                  <ShieldAlert className={`w-5 h-5 ${isNavActive('ADMIN_USERS') ? 'text-white' : 'text-emerald-600'}`} />
                  <span>Quản Trị Tài Khoản</span>
                </div>
                <ChevronRight className={`w-4 h-4 ${isNavActive('ADMIN_USERS') ? 'text-white' : 'text-slate-400'}`} />
              </button>
              ...
              <button
                ...
                className="w-full flex items-center justify-between px-4 py-3 rounded-2xl text-sm font-extrabold text-slate-800 hover:text-emerald-950 bg-slate-50/80 hover:bg-emerald-50/80 border border-slate-200/80 hover:border-emerald-200/80 transition-all cursor-pointer"
              >
                <div className="flex items-center gap-3">
