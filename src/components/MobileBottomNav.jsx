...
import { Table, LayoutList, BarChart3, MapPin, Plus, Download } from 'lucide-react';
...
export default function MobileBottomNav({
  ...
  const isFacilityRole = currentUser?.role === 'FACILITY';
        ...
        {isFacilityRole ? (
          <>
            ...
            <button
              ...
              className="flex flex-col items-center gap-0.5 px-3 py-1 rounded-2xl transition-all text-slate-300 hover:text-white cursor-pointer"
            >
              <Download className="w-5 h-5 text-emerald-400" />
              <span className="text-[10px] font-bold">Xuất Sổ</span>
            </button>
          </>
        ) : (
          <>
